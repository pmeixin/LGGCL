...
#training process
def train(epoch, sample_size, debias, data_aug, neg_type, pos_type, kk: int = 1):
    model.train()
    optimizer.zero_grad()
...
for i in range(times):
    ...
    for epoch in range(args.epochs):
        loss_val, acc_val = train(epoch, args.sample_size, args.debias, args.data_aug, args.neg_type, args.pos_type)
