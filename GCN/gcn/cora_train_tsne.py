...
for i in range(times):
    ...
    # Testing
    test_acc[i], test_logits = test(best_model, features, adj, labels, idx_test, args.encoder_type)
...
#plt.legend(loc=0)
plt.savefig('cora_LGGCL_SGC.png')
plt.show()
