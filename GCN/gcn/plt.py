...
#for i in range(200):
#     x1.append(i+1)
x1 = [1, 2, 5, 10, 15, 25, 50, 100, 200]
#y1 = [5849048,4959022,2898030,3150552,2919482,1189186,1043194,980404,981292]
#y1 = [8938620,8618580,6137704,4380658,3525346,1953640,1591368,1565378,1562768]
y1 = [119469982,104827538,73426476,61260156,66098668,47266862,45532456,44891530,43732352]
...
#A, = plt.plot(x1, y1, 'r^-', label='Cora',ms=8, linewidth=2.5)
#A, = plt.plot(x1, y1, 'b^-', label='CiteSeer',ms=8, linewidth=2.5)
A, = plt.plot(x1, y1, 'g^-', label='PubMed',ms=8, linewidth=2.5)
...
plt.ylabel('number of filtered nodes', font2)
